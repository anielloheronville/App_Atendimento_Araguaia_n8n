...
# O Render vai injetar as senhas automaticamente via Variáveis de Ambiente.
N8N_WEBHOOK_URL = os.environ.get("N8N_WEBHOOK_URL")
DATABASE_URL = os.environ.get("DATABASE_URL")

# --- DADOS DO LOGO (COMPLETO) ---
LOGO_BASE64_STRING = (
            ...
            <form id="preAtendimentoForm" class="p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div>
                        ...
                        <textarea id="abordagem_inicial" name="abordagem_inicial" rows="4" class="form-textarea"></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="loteamento" name="loteamento" class="form-input">
                    </div>
                    </div>
...
def formatar_telefone_n8n(telefone_bruto):
    ...
    try:
        ...
        # Verifica se tem DDD + 9 dígitos (11 dígitos) ou DDD + 8 dígitos (10 dígitos)
        ...
        try:
            ...
            if N8N_WEBHOOK_URL:
                try:
                    ...
                    # Timeout curto para não travar a experiência do usuário
                    ...
                    # Não falhamos o request do usuário se o n8n falhar, apenas logamos
...
if __name__ == '__main__':
    ...
    # Modo debug ajuda no desenvolvimento, remova em produção real
